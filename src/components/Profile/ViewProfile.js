  ...
  return (
    <div className="mt-[60px] w-full">
      ...
      <div className="relative h-[300px] shadow-md mx-20 lg:mx-60 flex flex-col items-center rounded-b-sm">
        ...
        <Link to="/profile/edit" className="py-2 text-lg mt-24 w-[150px] font-medium rounded-md bg-sky-600 text-white hover:opacity-80 transition-opacity duration-300">
          Chỉnh sửa
        </Link>
        <p className="text-4xl font-extrabold my-3">Ten</p>
